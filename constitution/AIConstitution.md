...
<blockquote>
  ...
  <p>In terms of understanding the contribution of Cardano to the world, would the Draft Constitution or chatbot processing more likely resonate with a wider audience? There seems some irony in the observation that the draft prepared by human beings seeks to incorporate elements of desiring to use bots or algorithms in Cardano governance, and applying the logic of the human draft by asking a chatbot to prepare a constitution returns a constitution addressed only to human beings and reflecting human values. Some may evaluate the chatbot processing as a reason to continue including support for bots—and perhaps even include processing that a chatbot may offer—in the Draft Constitution. Others may conclude that the idea of implementing script-based DReps should be removed from the Constitution, in order to support the painstaking human-involved governance process fully (or, perhaps to follow the implicit suggestion of the chatbot).</p>
