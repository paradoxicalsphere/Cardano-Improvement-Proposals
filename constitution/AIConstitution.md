...
<blockquote>
  ...
  <p>In response to the suggestion in the Draft Constitution that some Delegated Representatives (DReps) may be script-based as part of minimum viable governance, I messaged the ChatGPT artificial intelligence (AI) chatbot to <code>write a constitution for the cardano blockchain</code>, returning the following results.</p>
