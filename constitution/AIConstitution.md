...
<blockquote>
  ...
  <p>There seems some irony in the observation that the human draft seeks to incorporate an element of desiring to use bots or algorithms in Cardano governance, whereas going through the door that opens and subsequently asking a chatbot clearly returns a constitution addressed only to human beings and reflecting human values. While some may interpret the observation as a reason to continue including support for bots in the Draft Constitution that has been a work in progress for such a long time, others may conclude that consequently the idea of implementing script-based DReps should be removed from the human draft, to support the governance process fully, as well as to acknowledge the suggestion of the chatbot, potentially.
