...
<p align="center">
<code>—<a href="https://nationworldnews.com/cardano-foundation-official-says-there-are-different-use-cases-for-different-blockchains/">Mel McCann</a>, vice president of engineering at the Cardano Foundation</code>
</p>
...
To address the challenge of multiple-pool operators using an implementation of the current proposal, in a scenario where multiple-pool operators may be identified as centralizing or introducing fragility into the network "too much," on individual or collective bases employees may delegate or redelegate discretionary (t)ADA to stake pools identified as single-pool operations—within the constraints established by the founding entities Input Output, Cardano Foundation and EMURGO—to maintain or restore a balance of decentralization and resilience within the Cardano network.
