...
* Create closed sets
* Add wallet addresses to closed sets<sup><a href="#addwallets">3</a></sup>
* Remove wallet addresses from closed sets<sup><a href="#removewallets">4</a></sup> <!-- Add wallet addresses to—or remove wallet addresses from—closed sets -->
...
<a name="addwallets"></a><sup>3</sup> Wallet addresses may carry zero or non-zero balances.

<a name="removewallets"></a><sup>4</sup> Only the employer may send (t)ADA from wallet addresses removed from closed sets. <!-- <a name="private"></a><sup>4</sup> The relationships between closed sets may be private. -->
