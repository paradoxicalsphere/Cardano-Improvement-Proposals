...
<a name="addwallets"></a><sup>4</sup> Wallet addresses may carry zero or non-zero balances. Only the employee—NOT the employer—may send or stake (t)ADA from wallet addresses added to a closed set.
