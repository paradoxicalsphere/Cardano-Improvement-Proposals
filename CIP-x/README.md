...
<a name="balances"></a><sup>3</sup> Wallet addresses may carry zero or non-zero balances.

<a name="private"></a><sup>4</sup> The relationships between closed sets may be private.
