...
The current proposal supports intelligently embedding the aforementioned principles in the [Constitution](https://constitution.gov.tools/en/interim-constitution) as minimum viable values.
