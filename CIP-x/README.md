...
<a name="dependency"></a><sup>1</sup> The current CIP draft reflects research conducted by the [Center for Humane Technology](https://www.humanetech.com/). The decision-making processes outlined in the current CIP draft may at times lead to consensus, and often may not reach any consensus. Decision-making processes having requirements for an end goal of broad consensus based on token-weighted governance—such as [CIP-1694](https://github.com/JaredCorduan/CIPs/blob/voltaire-v1/CIP-1694/README.md)—are out of scope for the current CIP. The current CIP proposes an approach to mitigate risks associated with token-weighted governance models, in which users with the most tokens have the biggest share of voting power.
...
<a name="questions"></a><sup>3</sup> The development of poll or survey questions is out of scope for the current CIP draft.
