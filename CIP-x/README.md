...
<a name="removewallets"></a><sup>5</sup> Only the employer may send (t)ADA from wallet addresses removed from closed sets. <!-- <a name="private"></a><sup>4</sup> The relationships between closed sets may be private. -->
