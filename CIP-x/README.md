...
Using an implementation of the current proposal, in a scenario where multiple-pool operators may be identified as centralizing the network "too much," employees may delegate or redelegate (t)ADA to single stake pools at their discretion, individually or collectively, within the constraints established by the founding entities Input Output, Cardano Foundation and EMURGO to maintain or restore a balance of decentralization within the Cardano network.
