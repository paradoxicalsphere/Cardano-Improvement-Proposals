...
* Create closed sets; add or remove wallet addresses belonging to a closed set; and, set strictly-enforced permissions for closed sets in terms of the other closed sets allowed to send (t)ADA to wallet addresses in the closed set
