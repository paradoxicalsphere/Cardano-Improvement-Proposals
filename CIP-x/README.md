...
<a name="dependency"></a><sup>1</sup> For making decisions that require reaching an explicit consensus, the current CIP draft depends on a governance framework such as [CIP-1694](https://github.com/JaredCorduan/CIPs/tree/voltaire-v1/CIP-1694).
