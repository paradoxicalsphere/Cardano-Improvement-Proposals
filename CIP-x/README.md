...
* Create closed sets, and then add or remove wallet addresses belonging to a closed set
...
Smart contracts that may be implemented in relation to the current CIP adhere to the closed set definitions.
