...
Are you interested in more sustainable, progressive and collaborative governance for Cardano, as well as greater accountability for our investments in the ecosystem, to help Cardano thrive as an ecosystem based on values? The Cardano protocol is a means to economy—not an end—and is not perfect. With improved governance, the protocol may not require perfection.<sup><a href="#dependency">1</a></sup>
